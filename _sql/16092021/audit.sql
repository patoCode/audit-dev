...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-09-2021 a las 23:00:45
...
INSERT INTO `aud_menu` (`ID_MENU`, `MENU`, `ORDEN`, `ESTADO`, `ESTADO_REG`, `FECHA_REG`, `USUARIO_REG`, `FECHA_MOD`, `USUARIO_MOD`) VALUES
(1, 'PARAMETROS', 1, 'activo', 'vigente', '2021-09-16 17:39:14', '', '2021-09-16 17:39:14', ''),
(2, 'Empresa', 0, 'activo', 'vigente', '2021-09-16 20:24:28', '', '2021-09-16 20:24:28', ''),
(3, 'Procesos', 2, 'activo', 'vigente', '2021-09-16 20:24:28', '', '2021-09-16 20:24:28', '');
...
INSERT INTO `aud_privilegio` (`ID_PRIVILEGIO`, `ID_MENU`, `PRIVILEGIO`, `URI`, `DESCRIPCION`, `ORDEN`, `FECHA_REG`, `USER_REG`, `FECHA_MOD`, `USER_MOD`, `ESTADO_REG`, `ESTADO`) VALUES
(1, 2, 'EMPRESA', 'Dashboard/Empresa', 'CRUD DE EMPRESA', 1, '2021-09-16 17:28:25', '', NULL, 'vigente', 'vigente', 'activo'),
(2, 1, 'REGISTRO USUARIOS', 'Dashboard/usuario', 'CRUD USUARIOS', 2, '2021-09-16 17:29:58', '', NULL, '', 'vigente', 'activo'),
(3, 1, 'REGISRO CLIENTES', 'Dashboard/cliente', 'Crud Clientes', 1, '2021-09-17 02:21:02', 'user', '2021-09-17 02:23:47', 'user', 'vigente', 'activo'),
(4, 2, 'REGISTRO USUARIOS', 'Dashboard/usuario', 'REGISTRO USUARIOS', 1, '2021-09-16 20:26:50', '', '2021-09-16 20:26:50', '', 'vigente', 'activo'),
(5, 1, 'REGISTRO INSTITUCION', 'Dashboard/institucion', 'REGISTRO INSTITUCION', 2, '2021-09-16 20:26:50', '', '2021-09-16 20:26:50', '', 'vigente', 'activo'),
(6, 1, 'REGISTRO OBLIGACION', 'Dashboard/obligacion', 'REGISTRO OBLIGACION', 3, '2021-09-16 20:26:50', '', '2021-09-16 20:26:50', '', 'vigente', 'activo'),
(7, 1, 'REGISTRO SOCIEDAD', 'Dashboard/sociedad', 'REGISTRO SOCIEDAD', 3, '2021-09-16 20:26:50', '', '2021-09-16 20:26:50', '', 'vigente', 'activo'),
(8, 1, 'REGISTRO REGIMEN', 'Dashboard/regimen', 'REGISTRO REGIMEN', 3, '2021-09-16 20:26:50', '', '2021-09-16 20:26:50', '', 'vigente', 'activo'),
(9, 1, 'REGISTRO ACTIVIDAD', 'Dashboard/actividad', 'REGISTRO ACTIVIDAD', 3, '2021-09-16 20:26:50', '', '2021-09-16 20:26:50', '', 'vigente', 'activo'),
(10, 1, 'REGISTRO PERIODO', 'Dashboard/periodo', 'REGISTRO PERIODO', 3, '2021-09-16 20:26:50', '', '2021-09-16 20:26:50', '', 'vigente', 'activo'),
(11, 1, 'REGISTRO CERTIFICADOS', 'Dashboard/certificado', 'REGISTRO CERTIFICADOS', 3, '2021-09-16 20:26:50', '', '2021-09-16 20:26:50', '', 'vigente', 'activo');
...
CREATE TABLE `aud_rol` (
  ...
  `FECHA_MOD` timestamp NOT NULL DEFAULT current_timestamp(),
  `USER_MOD` varchar(200) COLLATE utf8_spanish2_ci NOT NULL,
  `ESTADO_REG` enum('1','0') COLLATE utf8_spanish2_ci NOT NULL DEFAULT '1',
...
INSERT INTO `aud_rol` (`ID_ROL`, `ROL`, `DESCRIPCION`, `CODE`, `FECHA_REG`, `USER_REG`, `FECHA_MOD`, `USER_MOD`, `ESTADO_REG`, `ESTADO`) VALUES
(1, 'Administrador', 'Rol de administracion', 'AD', '2021-09-16 17:31:19', '', '2021-09-16 17:31:19', '', '1', 'activo'),
(2, 'Operador', 'Rol Operador', 'OP', '2021-09-17 01:29:08', 'user', '2021-09-17 01:52:11', 'user', '1', 'activo');
...
INSERT INTO `aud_usuario` (`ID_USUARIO`, `NOMBRE_PROPIO`, `APELLIDOS`, `USERNAME`, `PASSWORD`, `EMAIL`, `FOTO`, `ESTADO`, `ESTADO_REG`, `FECHA_REG`, `USER_REG`, `FECHA_MOD`, `USER_MOD`) VALUES
(1, 'Juan', 'Perez Soto', 'admin123', '0192023a7bbd73250516f069df18b500', 'juan@juan.com', '<p>\n	dsa</p>\n', 'activo', 'vigente', '2021-09-16 21:49:31', '#DENIS', '2021-09-17 02:56:31', '#DENIS');
