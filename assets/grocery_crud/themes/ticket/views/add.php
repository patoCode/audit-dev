<?php
	...
	$this->set_js_lib($this->default_theme_path.'/ticket/js/jquery.form.js');
    $this->set_js_lib($this->default_javascript_path.'/jquery_plugins/jquery.form.min.js');
	$this->set_js_config($this->default_theme_path.'/ticket/js/flexigrid-add.js');
			...
			<div class="card-footer clearfix">
				<div class="float-right">
					...
					<?php if(!$this->unset_back_to_list) { ?>
						...
						<input type='button' value='<?php echo $this->l('form_save'); ?>' id="save-and-go-back-button"  class="btn btn-large btn-success"/>

						<input type='button' value='<?php echo $this->l('form_cancel'); ?>' class="btn btn-large btn-secondary border-primary" id="cancel-button" />
