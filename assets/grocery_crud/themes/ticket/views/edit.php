<?php
	...
	$this->set_js_config($this->default_theme_path.'/ticket/js/flexigrid-edit.js');
	...
	<div id='main-table-box' class="card">
		...
		<div class="card-footer clearfix">
			<div class="float-right">
				<!-- <input  id="form-button-save" type='submit' value='' class="btn btn-large btn-success"/> -->

			<?php if(!$this->unset_back_to_list) { ?>
				<input type='button' value='<?php echo $this->l('form_update_changes'); ?>' id="save-and-go-back-button" class="btn btn-large btn-success"/>
				<input type='button' value='<?php echo $this->l('form_cancel'); ?>' class="btn btn-large btn-secondary border" id="cancel-button" />
			<?php } ?>
