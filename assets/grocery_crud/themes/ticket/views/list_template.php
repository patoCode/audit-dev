<?php
	$this->set_css($this->default_theme_path.'/ticket/css/flexigrid.css');
	...
	$this->set_js($this->default_theme_path.'/ticket/js/cookies.js');
	$this->set_js($this->default_theme_path.'/ticket/js/flexigrid.js');

    $this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.form.min.js');

	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/ticket/js/jquery.printElement.min.js');
...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="row">
		...
		<div class="col-md-12 form-group" id='quickSearchBox'>
			<label for="list" class="form-control border-0 font-weight-bold col-md-1 col-xs-6">
				<?php echo $this->l('list_search');?>:
			</label>
			<input type="text" class="qsbsearch_fieldox search_text form-control col-md-8 col-xs-6" name="search_text" size="30" id='search_text'>
			<select name="search_field" id="search_field" class="custom-select my-1 mr-sm-22 col-md-1 col-xs-6">
		...
		<div class="pDiv col-12 bg-secondary border">
		<div class="pDiv2" style="padding: 2px">
			<div class="pGroup">
				<span class="pcontrol">
