<?php
	$this->set_css($this->default_theme_path.'/audit/css/flexigrid.css');
	...
	$this->set_js($this->default_theme_path.'/audit/js/cookies.js');
	$this->set_js($this->default_theme_path.'/audit/js/flexigrid.js');

    $this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.form.min.js');

	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/audit/js/jquery.printElement.min.js');
...
<?php }
?></div>
<div class="col-md-12 grid-margin" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="tDiv">
		<?php if(!$unset_add){?>
		<div class="tDiv2">
        	<a href='<?php echo $add_url?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>' class='add-anchor add_button btn btn-success btn-rounded btn-icon' alt="<?php echo $this->l('list_add').' '.$subject?>">
        		<i class="ti-plus"></i>
			</a>
